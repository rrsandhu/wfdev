...
export function generateStaticParams() {
  return rentals.map((r) => ({ slug: r.id }));
}
...
export async function generateMetadata({
  ...
  const rental = rentals.find((r) => r.id === slug);
  if (!rental) return {};
  return {
    title: `${rental.name} | Apartment Rentals | West Fraser Developments`,
    ...
    <>
      ...
      <section className="relative h-[45vh] md:h-[65vh] flex items-end overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-8 pb-16 w-full">
          <span className="inline-block bg-white text-gray-900 text-[10px] font-bold uppercase tracking-[0.15em] px-3 py-1.5 mb-4">
            {rental.available}
          </span>
          <h1
          ...
          <p className="text-white/60 text-[15px] font-medium">
            {rental.neighbourhood} &middot; {rental.location}
          </p>
        </div>
      </section>
      ...
      <section className="bg-gray-900 border-t border-white/5">
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 grid grid-cols-2 md:grid-cols-4 gap-px bg-white/8">
          {[
            { label: "Availability", value: rental.available },
            { label: "Suite Types", value: rental.suites },
            ...
            <div className="border border-gray-100 rounded-xl p-8 sticky top-28">
              ...
              <dl className="space-y-4 mb-8">
                {[
                  ...
                  { label: "Suite Types", value: rental.suites },
                  { label: "Neighbourhood", value: rental.neighbourhood },
                  { label: "Address", value: rental.address ?? rental.neighbourhood },
                ].map((d) => (
      ...
      <section className="py-20 bg-gray-900 text-center px-6">
        ...
        >
          Get in touch with our rental team.
        </h2>
        <p className="text-gray-400 text-[15px] max-w-md mx-auto mb-10">
          Our team is ready to answer your questions and help you find the right suite.
        </p>
